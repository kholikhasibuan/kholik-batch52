...
async function home(req, res) {
    try {
        const query = 'SELECT * FROM personalweb';
        const obj = await sequelize.query(query, { type: QueryTypes.SELECT });
        console.log(obj)

        // Menyimpan data dari database ke array 'data'
...
async function updateProjectView(req, res) {
    ...
    const dataFilter = await sequelize.query("select * from personalweb where author_id ="+ id,{type:QueryTypes.SELECT})
